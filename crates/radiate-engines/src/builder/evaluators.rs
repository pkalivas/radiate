    ...
    T: Clone,
{
    ...
    pub event_executor: Arc<Executor>,
    pub sync: ThreadSync,
}
    ...
    T: Clone + Send,
{
    ...
    pub fn event_executor(mut self, executor: impl Into<Arc<Executor>>) -> Self {
        self.params.evaluation_params.event_executor = executor.into();
        self
    }
}
