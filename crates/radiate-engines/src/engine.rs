...
pub struct SingleObjectiveEngine<C, T>
where
    C: Chromosome,
    T: Clone + Send + Sync + 'static,
{
...
impl<C, T> SingleObjectiveEngine<C, T>
where
    C: Chromosome,
    T: Clone + Send + Sync + 'static,
{
...
impl<C, T> Engine for SingleObjectiveEngine<C, T>
where
    C: Chromosome + Clone,
    T: Clone + Send + Sync + 'static,
{
...
impl<C, T> Engine for MultiObjectiveEngine<C, T>
where
    C: Chromosome + Clone,
    T: Clone + Send + Sync + 'static,
{
