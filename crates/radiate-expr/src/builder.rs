use crate::nodes::{
    aggregate::{ReduceExpr, RollingExpr, Rollup},
...
impl Expr {
    ...
    pub fn attr(self, attr: impl Into<SmallStr>) -> Expr {
        match self.node {
            ExprNode::Selector(selector) => Expr::from(selector.attr(attr)),
            _ => self,
        }
    }
    ...
    pub fn rolling(self, window_size: usize) -> Expr {
        Expr::from(RollingExpr::new(self, window_size))
    }

    pub fn first(self) -> Expr {
        Expr::from(ReduceExpr::new(self, Rollup::First))
    }

    pub fn last(self) -> Expr {
        Expr::from(ReduceExpr::new(self, Rollup::Last))
    }

    pub fn sum(self) -> Expr {
        Expr::from(ReduceExpr::new(self, Rollup::Sum))
    }

    pub fn mean(self) -> Expr {
        Expr::from(ReduceExpr::new(self, Rollup::Mean))
    }

    pub fn stddev(self) -> Expr {
        Expr::from(ReduceExpr::new(self, Rollup::StdDev))
    }

    pub fn min(self) -> Expr {
        Expr::from(ReduceExpr::new(self, Rollup::Min))
    }

    pub fn max(self) -> Expr {
        Expr::from(ReduceExpr::new(self, Rollup::Max))
    }

    pub fn var(self) -> Expr {
        Expr::from(ReduceExpr::new(self, Rollup::Var))
    }

    pub fn skew(self) -> Expr {
        Expr::from(ReduceExpr::new(self, Rollup::Skew))
    }

    pub fn count(self) -> Expr {
        Expr::from(ReduceExpr::new(self, Rollup::Count))
    }

    pub fn slope(self) -> Expr {
        Expr::from(ReduceExpr::new(self, Rollup::Slope))
    }

    pub fn unique(self) -> Expr {
        Expr::from(ReduceExpr::new(self, Rollup::Unique))
    }
    ...
    pub fn quantile(self, q: f32) -> Expr {
        Expr::from(ReduceExpr::new(self, Rollup::Quantile(q)))
    }
...
//     pub fn stddev(self) -> Expr {
//         Expr::from(AggExpr::new(self, Rollup::StdDev))
...
//     pub fn min(self) -> Expr {
//         Expr::from(AggExpr::new(self, Rollup::Min))
...
//     pub fn max(self) -> Expr {
//         Expr::from(AggExpr::new(self, Rollup::Max))
...
//     pub fn var(self) -> Expr {
//         Expr::from(AggExpr::new(self, Rollup::Var))
...
//     pub fn skew(self) -> Expr {
//         Expr::from(AggExpr::new(self, Rollup::Skew))
...
//     pub fn count(self) -> Expr {
//         Expr::from(AggExpr::new(self, Rollup::Count))
...
//         if let ExprNode::Aggregate(ref mut agg) = self.node
