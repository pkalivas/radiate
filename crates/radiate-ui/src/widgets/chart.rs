...
impl<'a> From<Vec<&'a ChartInner>> for ChartWidget<'a> {
    fn from(value: Vec<&'a ChartInner>) -> Self {
        Self::new(value)
    }
}

impl<'a> From<&'a ChartInner> for ChartWidget<'a> {
    fn from(value: &'a ChartInner) -> Self {
        Self::new(vec![value])
    }
}

impl<'a> From<Option<&'a ChartInner>> for ChartWidget<'a> {
    fn from(value: Option<&'a ChartInner>) -> Self {
        match value {
...
impl<'a> From<Vec<Option<&'a ChartInner>>> for ChartWidget<'a> {
    fn from(value: Vec<Option<&'a ChartInner>>) -> Self {
