...
fn main() {
    ...
    let graph_codex = TreeCodex::new(1, 3)
    ...
    let engine = GeneticEngine::from_codex(graph_codex)
        ...
        .fitness_fn(move |tree: Vec<Tree<f32>>| regression.eval(&tree))
        .build();
...
fn display(result: &EngineContext<TreeChromosome<f32>, Vec<Tree<f32>>>) {
