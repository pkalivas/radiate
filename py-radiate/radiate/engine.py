...
from radiate.radiate import PyEngine, PyEngineParam
...
class Engine:
    ...
    def __build_alterers(genome: None | Union[Genome, Dict[str, Any]] = None, alters: None | Alterer | List[Alterer] = None) -> List[PyEngineParam]:
