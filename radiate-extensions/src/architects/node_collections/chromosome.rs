use crate::{GraphNode, NodeType, OpStore};
    ...
    T: Clone + PartialEq + Default,
{
    ...
    pub factory: Option<Rc<RefCell<OpStore<T>>>>,
}
    ...
    T: Clone + PartialEq + Default,
{
    ...
    pub fn with_factory(nodes: Vec<GraphNode<T>>, factory: Rc<RefCell<OpStore<T>>>) -> Self {
        NodeChromosome {
            nodes,
