use crate::{IndexedNode, Node, NodeFactory, NodeType};
...
where
    T: Clone + PartialEq + Default,
{
    pub fn new(nodes: Vec<IndexedNode<T>>) -> Self {
        GraphChromosome {
            nodes,
            factory: None,
        }
    ...
    pub fn with_factory(nodes: Vec<IndexedNode<T>>, factory: Rc<RefCell<NodeFactory<T>>>) -> Self {
        GraphChromosome {
            nodes,
