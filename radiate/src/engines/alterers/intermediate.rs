...
impl<C: Chromosome<Gene = FloatGene>> EngineAlterer<C> for IntermediateCrossover {
    fn rate(&self) -> f32 {
        self.rate
    }
...
impl<C: Chromosome<Gene = FloatGene>> CrossoverAction<C> for IntermediateCrossover {
