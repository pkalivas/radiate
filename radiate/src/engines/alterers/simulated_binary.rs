...
impl<C: Chromosome<Gene = FloatGene>> EngineAlterer<C> for SimulatedBinaryCrossover {
    fn rate(&self) -> f32 {
        self.crossover_rate
    }
...
impl<C: Chromosome<Gene = FloatGene>> CrossoverAction<C> for SimulatedBinaryCrossover {
