# Mirror of docs/source/engine/index.md (the runnable snippets). The long-running
# "Running" demo (ui=True + checkpoint) lives in engine/index_showcase.py, which is
# excluded from the run test.
#
